...
echo "I believe in the importance of $TOOL because it fosters community innovation." >> "$OUTPUT_FILE"
echo "To me, software freedom is truly about $FREEDOM." >> "$OUTPUT_FILE"
echo "I am committed to building $BUILD and sharing it with the world freely." >> "$OUTPUT_FILE"
